	...
	public void placeArmy() {
		...
		if(allSelected == false) {
			...
			if(getTerritoriesOwned().size() == 0) {
				...
				//when full look at adjacent continent for empty territories or grab available territory
				...
				//	}//second if statement
						...
						//used to be else statement with random number generator. .nextInt
				}//getTerritoriesOwned.size() if statement
			
				if(ChooseContinent.equals("North America")){
					int i =0;
					while(i<NA.size()){
						...
						if(i==NA.size()){
							...
							while(n<getAllTerritories().size()){
								if(getAllTerritories().get(n).getCurrentOwner()==null){
									getAllTerritories().get(n).setCurrentOwner(this);
									break;
								}
								else{n++;}
							}
				...
				if(ChooseContinent.equals("South America")){
					int i =0;
					while(i<SA.size()){
				...
				if(ChooseContinent.equals("Europe")){
					int i =0;
					while(i<EU.size()){
				...
				if(ChooseContinent.equals("Africa")){
					int i =0;
					while(i<AF.size()){
				...
				if(ChooseContinent.equals("Asia")){
					int i =0;
					while(i<ASI.size()){
				...
				if(ChooseContinent.equals("Australia")){
					int i =0;
					while(i<AUS.size()){
